...
// Базовый класс Node, представляющий узел списка
class Node {
protected:
...
// Производный класс 1, добавляющий имя узла
class DerivedNode1 : public Node {
private:
    std::string name; // Имя узла

public:
    // Конструктор, инициализирующий ID и имя узла
...
// Производный класс 2, добавляющий числовое значение
class DerivedNode2 : public Node {
private:
    double value; // Значение узла

public:
    // Конструктор, инициализирующий ID и значение узла
